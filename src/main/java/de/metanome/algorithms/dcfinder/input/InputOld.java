...
public class InputOld {
    ...
    public InputOld(RelationalInput relationalInput) {
        this(relationalInput, -1);
    }

    public InputOld(RelationalInput relationalInput, int rowLimit) {
    ...
    public InputOld(RelationalInput relationalInputOrigin, RelationalInput relationalInputNew){
