...
import ADCD.plishard.Cluster;
import ADCD.plishard.Pli;
 ...
 */
public class UnaryPliClueSetBuilder extends ClueSetBuilder {

    private final List<Pli> plis;
    private final int tidBeg, tidRange;
    private final int evidenceCount;

    public UnaryPliClueSetBuilder(PliShard shard) {
        plis = shard.plis;
        tidBeg = shard.beg;
    ...
    private void setSingleEQ(long[] clues, Cluster cluster, long mask) {
        ...
        //需要纠正两个地方 一个是tuple1，tuple2  另外一个是tuple2，tuple1
