...
//
//    public ApproxDCBuilder(long _minCoverCount, PredicateBuilder builder, boolean maxIntersect, boolean parallelADC) {
//        minCoverCount = _minCoverCount;
//        traverser = new ApproxCoverTraverser(builder.getPredicates().size(), minCoverCount, builder.getMutexMap(), maxIntersect, parallelADC);
